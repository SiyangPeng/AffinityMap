...
data_columns <- c(5:100)

# Separate by probe concentration
conc1_column_names <- c(5:28)
conc2_column_names <- c(29:52)
conc3_column_names <- c(53:76)
conc4_column_names <- c(77:100)
...
metadata_columns <- c('Protein.Group','Protein.Names', 'Genes', 
...
data_combined_NAs <-msnset_normed_imputed@featureData@data[,'NA_percent']
