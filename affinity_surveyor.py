...
# input_file_path = 'input_file_path/input_file.csv'
# output_file_path = 'output_file_path/output_file.csv'
input_file_path = '/Users/siyangpeng/Desktop/affinity_map/2026_sub/v2_prev_sub_code/data_preprocessed_separate.csv'
output_file_path = 'output_file_path/output_file.csv'
...
catalyst_conc = [1,0.1,0.01,0.001] * 24
